                ...
                <x-auth-validation-errors class="mb-4" :errors="$errors" />
                  ...
                  <form id="delete_{{ $image->id }}" method="post" action="{{ route('owner.images.destroy', ['image' => $image->id ] )}}">
                    ...
                    <div class="md:px-4 py-3">
                      <a href="#" data-id="{{ $image->id }}" onclick="deletePost(this)" type="submit" class="text-white bg-red-400 border-0 py-2 px-4 focus:outline-none hover:bg-red-200 rounded">削除する</a>
                    </div>
                  </form>
              </div>
          </div>
